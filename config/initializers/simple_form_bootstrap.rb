...
SimpleForm.setup do |config|
  ...
  config.wrappers :horizontal_form, tag: 'div', class: 'form-group row', error_class: 'has-error', valid_class: 'has-success' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
    ...
    b.wrapper tag: 'div', class: 'col-sm-7' do |ba|
      ...
      ba.use :error, wrap_with: { tag: 'span', class: 'form-text' }
  ...
  config.wrappers :horizontal_boolean, tag: 'div', class: 'form-group', error_class: 'has-error', valid_class: 'has-success' do |b|
    ...
    b.wrapper tag: 'div', class: 'col-sm-offset-2 col-sm-7' do |wr|
      ...
      wr.use :error, wrap_with: { tag: 'span', class: 'form-text' }
